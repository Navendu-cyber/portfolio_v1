...
const CircuitBackground: React.FC<{ isDark?: boolean }> = ({ isDark = true }) => {
  return (
    <div className="fixed inset-0 z-0 pointer-events-none overflow-hidden">
      {/* Static Grid */}
      <div className={`absolute inset-0 bg-[size:4rem_4rem] transition-opacity duration-300 ${
        isDark 
          ...
          : "bg-[linear-gradient(to_right,#cbd5e1_1px,transparent_1px),linear-gradient(to_bottom,#cbd5e1_1px,transparent_1px)] opacity-10"
      }`}></div>
